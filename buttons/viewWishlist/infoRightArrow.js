const { EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, RESTJSONErrorCodes, ButtonInteraction } = require('discord.js');
const superagent = require('superagent');
const command = require('../../commands/checkWishlist.js');
require('dotenv').config( { path: ".env" } )

module.exports = {
    customID: 'infoRightArrow',
    ...
    async run(interaction) {
        ...
        console.log(wishlistItems.length, itemIndex)
        ...
        let row;
        if (itemIndex === wishlistItems.length-1) {
